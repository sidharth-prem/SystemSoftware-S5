...
void main()
{
 FILE *fint,*fcode,*flen,*fsym;
 int opl[10],txtlen,txtlen1,i,j=0,len;
 char
 ...
 fcode=fopen("opcode.txt","r");
 fsym=fopen("output.txt","r");
